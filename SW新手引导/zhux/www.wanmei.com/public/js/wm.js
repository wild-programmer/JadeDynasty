...
(function () {
    ...
    var bi = '../../../cookie.bi.wanmei.com/jsp/pvbi/wanmeibihd.js'/*tpa=http://cookie.bi.wanmei.com/jsp/pvbi/wanmeibihd.js*/;
    ...
    var top_ad = [
		{ srcsmall: wb + "/public/images/top/top2016/wanmei_gg_small_20161013.jpg?v=1", srcbig: wb + "/public/images/top/top2016/wanmei_gg_big_20161013.jpg?v=1", href: "http://shenmo.wanmei.com/" },
        { srcsmall: wb + "/public/images/top/top2016/wanmei_gg_small_20161013.jpg?v=1", srcbig: wb + "/public/images/top/top2016/wanmei_gg_big_20161013.jpg?v=1", href: "http://shenmo.wanmei.com/" },
        { srcsmall: wb + "/public/images/top/top2016/wanmei_gg_small_20161013.jpg?v=1", srcbig: wb + "/public/images/top/top2016/wanmei_gg_big_20161013.jpg?v=1", href: "http://shenmo.wanmei.com/" },
        { srcsmall: wb + "/public/images/top/top2016/wanmei_gg_small_20161013.jpg?v=1", srcbig: wb + "/public/images/top/top2016/wanmei_gg_big_20161013.jpg?v=1", href: "http://shenmo.wanmei.com/" }
    ];
    var Global = {
        'top': [
            ...
            { name: 'wanmei', skin: 1, pay: py, bbs: 'http://bbs.wanmei.com/', ad: 1 },
		    { name: 'sg', skin: 4, pay: pay('http://www.wanmei.com/public/js/newpay.do?op=prepay&gametype=5'), bbs: bbs('sg'), ad: 1},
		    { name: 'chibi', skin: 4, pay: pay('http://www.wanmei.com/public/js/newpay.do?op=prepay&gametype=5'), bbs: bbs('sg'), ad: 1},
		    { name: 'sgcq', skin: 1, pay: pay('http://www.wanmei.com/public/js/newpay.do?op=prepay&gametype=11'), bbs: bbs('sgcq'), ad: 1 },
		    { name: 'w2i', skin: 2, pay: pay('http://www.wanmei.com/public/js/newpay.do?op=prepay&gametype=3'), bbs: bbs('w2i'), ad: 1 },
		    { name: 'world2', skin: 1, pay: pay('http://www.wanmei.com/public/js/newpay.do?op=prepay&gametype=1'), bbs: bbs('world2'), ad: 1 },
		    { name: 'wulin2', skin: 3, pay: pay('http://www.wanmei.com/public/js/newpay.do?op=prepay&gametype=2'), bbs: bbs('wulin2'), ad: 1 },
            { name: 'wulin', skin: 3, pay: pay('http://www.wanmei.com/public/js/newpay.do?op=prepay&gametype=2'), bbs: bbs('wulin'), ad: 1 },
		    { name: 'kdxy', skin: 1, pay: pay('http://www.wanmei.com/public/js/newpay.do?op=prepay&gametype=7'), bbs: bbs('kdxy'), ad: 1 },
		    { name: 'zhuxian', skin: 3, pay: pay('http://www.wanmei.com/public/js/newpay.do?op=prepay&gametype=4'), bbs: bbs('zhuxian'), ad: 1 },
		    { name: 'zhuxian2', skin: 3, pay: pay('http://www.wanmei.com/public/js/newpay.do?op=prepay&gametype=4'), bbs: bbs('zhuxian2'), ad: 1 },
            { name: 'zhuxian3', skin: 3, pay: pay('http://www.wanmei.com/public/js/newpay.do?op=prepay&gametype=4'), bbs: bbs('zhuxian3'), ad: 1 },
		    { name: 'rwpd', skin: 1, pay: pay('http://www.wanmei.com/public/js/newpay.do?op=prepay&gametype=6'), bbs: bbs('rwpd'), ad: 1 },
		    { name: 'mhzx', skin: 1, pay: pay(''), bbs: bbs('xmhzx'), ad: 1 },
		    { name: 'shenmo', skin: 2, pay: pay('http://www.wanmei.com/public/js/newpay.do?op=prepay&gametype=12'), bbs: bbs('shenmo'), ad: 1 },
		    { name: 'sm', skin: 2, pay: pay('http://www.wanmei.com/public/js/newpay.do?op=prepay&gametype=12'), bbs: bbs('shenmo'), ad: 1 },
		    { name: 'xlzj', skin: 2, pay: pay(''), bbs: bbs('xlzj'), ad: 1 },
		    { name: 'sgsj', skin: 4, pay: pay('http://www.wanmei.com/public/js/newpay.do?op=prepay&gametype=18'), bbs: bbs('sgsj'), ad: 1 },
		    { name: 'qd', skin: 1, pay: py, bbs: bs, ad: 1 },
		    { name: 'xa', skin: 2, pay: pay('http://www.wanmei.com/public/js/newpay.do?op=prepay&gametype=16'), bbs: bbs('xa'), ad: 1 },
		    ...
		    { name: 'xljz', skin: 4, pay: pay('http://www.wanmei.com/public/js/setup_2_xljz.html'), bbs: bbs('xljz'), ad: 1 },
		    { name: 'xmhzx', skin: 1, pay: pay('http://www.wanmei.com/public/js/setup_2_mhzx.html'), bbs: bbs('xmhzx'), ad: 1 },
		    { name: 'seiya', skin: 4, pay: pay('http://www.wanmei.com/public/js/newpay.do?op=prepay&gametype=21'), bbs: bbs('seiya'), ad: 1 },
		    { name: 'sdxl', skin: 1, pay: pay('http://www.wanmei.com/public/js/newpay.do?op=prepay&gametype=19'), bbs: bs, ad: 1 },
		    { name: 'mhzx2', skin: 1, pay: pay('http://www.wanmei.com/public/js/newpay.do?op=prepay&gametype=8'), bbs: bbs('mhzx2'), ad: 1 },
            ...
            { name: 'sd', skin: 1, pay: pay('http://www.wanmei.com/public/js/newpay.do?op=prepay&gametype=25'), bbs: false, ad: 1 },
            { name: 'role', skin: 1, pay: pay(''), bbs: false, ad: 1 },
            { name: 'nw', skin: 1, pay: pay('http://www.wanmei.com/public/js/newpay.do?op=prepay&gametype=20000'), bbs: false, ad: 1 },
            { name: 'd', skin: 1, pay: pay(''), bbs: false, ad: 1 },
			{ name: 'esales', skin: 1, pay: pay(''), bbs: false, ad: 1 },
            { name: 'ts', skin: 2, pay: pay('http://www.wanmei.com/public/js/newpay.do?op=prepay&gametype=43'), bbs: false, ad: 1 },
    ...
    var top_skin = ['http://www.wanmei.com/public/js/top201604.css?v=1', 'http://www.wanmei.com/public/js/top201604.css?v=1', 'http://www.wanmei.com/public/js/top201604.css?v=1', 'http://www.wanmei.com/public/js/top201604.css?v=1', 'http://www.wanmei.com/public/js/top201604.css?v=1', 'http://www.wanmei.com/public/js/top201604.css?v=1', 'http://www.wanmei.com/public/js/top201604.css?v=1'];
    var top_css = {
    ...
    var bottom_skin = ['../../error/error.htm'/*tpa=http://www.wanmei.com/public/js/bottom1.css*/, '../../error/error.htm'/*tpa=http://www.wanmei.com/public/js/bottom1.css*/, '../../error/error.htm'/*tpa=http://www.wanmei.com/public/js/bottom2.css*/, '../../error/error.htm'/*tpa=http://www.wanmei.com/public/js/bottom3.css*/, '../../error/error.htm'/*tpa=http://www.wanmei.com/public/js/bottom4.css*/, '../../error/error.htm'/*tpa=http://www.wanmei.com/public/js/bottom5.css*/];
    var bottom_css = {
    ...
    if (!window.wm) {
        var wm = window.wm = {
            copyright: "http://www.wanmei.com/public/js/www.wanmei.com",
            edition: "1.0",
            game: 'wanmei',
            istop: true,
            isbottom: true,
            ...
            fastreg: function (options) {
                ...
                var defskin = "../../error/error.htm"/*tpa=http://www.wanmei.com/public/js/www.wanmei.com/public/style/fastreg/skin{num}.css*/;
                                    ...
                                    <ul class="wanmei_games_hot_list wanmei_clearfix">\
                                        <li>\
                                            <a href="http://zhuxian2.wanmei.com/" target="_blank" hidefocus="true" title="' + unescape("%u8BDB%u4ED93") + '">\
                                                <img src="../images/top/top201305/game_zhuxian.jpg"/*tpa=http://www.wanmei.com/public/images/top/top201305/game_zhuxian.jpg*/ alt="' + unescape("%u8BDB%u4ED93") + '" /></a>\
                                        ...
                                        <li>\
                                            <a href="http://w2i.wanmei.com/" target="_blank" hidefocus="true" title="' + unescape("%u5B8C%u7F8E%u56FD%u9645") + '">\
                                                <img src="../images/top/top201305/game_w2i.jpg"/*tpa=http://www.wanmei.com/public/images/top/top201305/game_w2i.jpg*/ alt="' + unescape("%u5B8C%u7F8E%u56FD%u9645") + '" /></a>\
                                        ...
                                        <li>\
                                            <a href="http://xa.wanmei.com/" target="_blank" hidefocus="true" title="' + unescape("%u7B11%u50B2%u6C5F%u6E56OL") + '">\
                                                <img src="../images/top/top201305/game_xa.jpg"/*tpa=http://www.wanmei.com/public/images/top/top201305/game_xa.jpg*/ alt="' + unescape("%u7B11%u50B2%u6C5F%u6E56OL") + '" /></a>\
                                            <span>' + unescape("%u7B11%u50B2%u6C5F%u6E56OL") + '</span>\
                                        </li>\
                                        <li>\
                                            <a href="http://t.wanmei.com/" target="_blank" hidefocus="true" title="' + unescape("TOUCH") + '">\
                                                <img src="../images/top/top201305/game_touch.jpg"/*tpa=http://www.wanmei.com/public/images/top/top201305/game_touch.jpg*/ alt="' + unescape("TOUCH") + '" /></a>\
                                            <span>' + unescape("TOUCH") + '</span>\
                                        </li>\
                                        <li>\
                                            <a href="http://www.dota2.com.cn/" target="_blank" hidefocus="true" title="DOTA2">\
                                                <img src="../images/top/top201305/game_dota2.jpg"/*tpa=http://www.wanmei.com/public/images/top/top201305/game_dota2.jpg*/ alt="DOTA2" /></a>\
                                            <span>DOTA2</span>\
                                        </li>\
                                    </ul>\
                                </div>\
...
"%u6DF7%u6C8C%u8BD5%u70BC")+'</a></li>\
                            ...
                            <div class="wanmei_games_r">\
								<a href="http://pgp.wanmei.com/" target="_blank" class="wmpassport" title="' + unescape("%u5B8C%u7F8E%u6E38%u620F%u5E73%u53F0")+ '"><img src="../../images/top/platform.jpg"/*tpa=http://www.wanmei.com/images/top/platform.jpg*/ alt="' + unescape("%u5B8C%u7F8E%u6E38%u620F%u5E73%u53F0")+ '" /></a>\
    ...
    function creatLogin(opt) {
    	var css = '../style/account/acc20150916.css'/*tpa=http://www.wanmei.com/public/style/account/acc20150916.css*/;

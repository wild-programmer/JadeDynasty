...
(function () {
  ...
  m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)
			...
			GA('require', 'linkid', 'error.htm'/*tpa=http://www.wanmei.com/public/js/linkid.js*/);
			GA('send', 'pageview');
    ...
    var wa = function (options) {
        ...
        if (g.domain == '.4games.com') src = 'wa-1.js'/*tpa=http://www.4games.com/wa.js*/;
        setTimeout(function () { loadJS(src) }, 10);
    };
    var sm = function (options) {
        if (options.siteId) {
            ...
            var src = 'sm.js'/*tpa=http://cdnmaster.com/sitemaster/sm.js*/;
            setTimeout(function () { loadJS(src) }, 10);
        }
    };
    var adm = function (options) {
        var src = 'admBcnActwm2.js'/*tpa=https://e.admaster.com.cn/sod/admBcnActwm2.js*/;
        loadJS(src, function () {
            var cmpnId = options;

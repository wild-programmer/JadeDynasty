...
(function () {
    var _v = "2.3.3", _q = "_mtxq", _t = true, _n = "(none)", _r = "(direct)", _f = false, _u = undefined, _l = "length",
        ...
        _d = "__mtx.gif"/*tpa=http://analytics.wanmei.com/__mtx.gif*/, _de = "__mtxe.gif"/*tpa=http://analytics.wanmei.com/__mtxe.gif*/;
    var ts = function () {
...
var __mtxUtils = {
    ...
    trackEvent:function (k, v) {
        var _d = "__mtxe.gif"/*tpa=http://analytics.wanmei.com/__mtxe.gif*/,
            gc = function (n) {
                var c = document.cookie;
                if (c == "")
                    return "none";

...
function addVideoPlayer(containerID,width,height,params){
	if( location.href.indexOf('http://www.wanmei.com/public/js/laohu.com') != -1){
		return;	
	}
	if(params){
